...
class Database {
	...
	public function open_connection() {
		$this->conn = mysqli_connect(server, user, pass, null, port);
		if(!$this->conn){
			echo "Problema en la conexión a la base de datos! Contacte al administrador!";
			exit();
		} else {
			$db_select = mysqli_select_db($this->conn, database_name);
			if (!$db_select) {
				echo "Problema al seleccionar la base de datos! Contacte al administrador!";
				exit();
			}
		}
	}
